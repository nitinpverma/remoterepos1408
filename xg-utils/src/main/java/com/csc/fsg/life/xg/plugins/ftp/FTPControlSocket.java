 ...
 * @version %G%
 * 
 *          This class supports client-side FTP operations
 */
public class FTPControlSocket {
	...
	/**
	 * Read the FTP server's reply to a previously issued command. RFC 959
	 * states that a reply consists of the 3 digit code followed by text. The 3
	 * digit code is followed by a hyphen if it is a muliline response, and the
	 * last line starts with the same 3 digit code.
	 * 
	 * @return reply string
	 */
	 ...
	 * If we get an unexpected reply we throw an exception, setting the message
	 * to that returned by the FTP server
	 * 
